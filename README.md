...
## 🌟 Overview
This project documents the development, construction, and testing of **Testbed 2**, a variable mechanical stiffness robotic arm. Built by **Matthieu Prigent**, this prototype serves as a learning platform for the development of future iterations (Testbed 3), focusing on tendon-driven actuation and variable impedance control.
